...
const combatVariants: Array<{
  ...
  {
    runtimeHookId: "sfx.combat.action_commit_skill",
    hookId: "sfx.combat.action_commit_skill.focus_release",
    variantKey: "combat.action_commit_skill.focus_release",
    variantLabel: "Focus release",
    materialLabel: "Neutral Energy",
    phase: "ActionCommitSkill",
    label: "Skill commit focus release",
    source: "BattleActorAudioSurface",
    description: "skill별 cast clip이 연결되기 전 공용 fallback 시전 시작음 후보입니다.",
  },
  {
    runtimeHookId: "sfx.combat.action_commit_heal",
    hookId: "sfx.combat.action_commit_heal.soft_invoke",
    variantKey: "combat.action_commit_heal.soft_invoke",
    variantLabel: "Soft invoke",
    materialLabel: "Warm Chime",
    phase: "ActionCommitHeal",
    label: "Heal commit soft invoke",
    source: "BattleActorAudioSurface",
    description: "힐 시전 시작의 부드러운 상승 신호 후보입니다.",
  },
  {
    runtimeHookId: "sfx.combat.impact_heal",
    hookId: "sfx.combat.impact_heal.warm_mend",
    variantKey: "combat.impact_heal.warm_mend",
    variantLabel: "Warm mend",
    materialLabel: "Warm Chime",
    phase: "ImpactHeal",
    label: "Heal impact warm mend",
    source: "BattleActorAudioSurface",
    description: "힐이 대상에게 닿는 완결 신호 후보입니다. soft_invoke와 쌍으로 들립니다.",
  },
  {
    runtimeHookId: "sfx.combat.guard_exit",
    hookId: "sfx.combat.guard_exit.wood_shield",
    variantKey: "combat.guard_exit.wood_shield",
    variantLabel: "Wood shield lower",
    materialLabel: "Wood / Strap",
    phase: "GuardExit",
    label: "Guard exit wood shield",
    source: "BattleActorAudioSurface",
    description: "나무 방패를 내리는 방어 해제음 후보입니다. guard_enter와 쌍으로 들립니다.",
  },
];
