...
Shader "TriForge/Mask Blend"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _DamageColor;
			float4 _BaseLayerMask_ST;
			float4 _TopLayerNormal_ST;
			float4 _TopLayerMask_ST;
			float4 _BaseLayerNormal_ST;
			float4 _MeshNormal_ST;
			float4 _TopLayerColor;
			float4 _TopLayerBaseColor_ST;
			float4 _AOColor;
			float4 _EdgeColor;
			float4 _Color2;
			float4 _Color1;
			float4 _BaseLayerBaseColor_ST;
			float4 _MeshMask_ST;
			...
			inline float4 TriplanarSampling582( TEXTURE2D(topTexMap), float4 topST, SAMPLER(samplertopTexMap), float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
			...
			inline float4 TriplanarSampling588( TEXTURE2D(topTexMap), float4 topST, SAMPLER(samplertopTexMap), float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
			...
			inline float3 TriplanarSampling585( TEXTURE2D(topTexMap), float4 topST, SAMPLER(samplertopTexMap), float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
			...
			inline float4 TriplanarSampling590( TEXTURE2D(topTexMap), float4 topST, SAMPLER(samplertopTexMap), float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
			...
			inline float3 TriplanarSampling592( TEXTURE2D(topTexMap), float4 topST, SAMPLER(samplertopTexMap), float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
			...
			inline float4 TriplanarSampling584( TEXTURE2D(topTexMap), float4 topST, SAMPLER(samplertopTexMap), float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar582 = TriplanarSampling582( _BaseLayerBaseColor, _BaseLayerBaseColor_ST, sampler_BaseLayerBaseColor, PositionWS, NormalWS, 1.0, temp_cast_0, 1.0, 0 );
				float4 BC133 = ( _Color1 * triplanar582 );
				float2 uv_MeshMask = input.ase_texcoord7.xy * _MeshMask_ST.xy + _MeshMask_ST.zw;
				...
				float4 triplanar588 = TriplanarSampling588( _TopLayerBaseColor, _TopLayerBaseColor_ST, sampler_TopLayerBaseColor, PositionWS, NormalWS, 1.0, temp_cast_2, 1.0, 0 );
				float4 TopBC187 = ( _TopLayerColor * triplanar588 );
				float2 uv_MeshNormal = input.ase_texcoord7.xy * _MeshNormal_ST.xy + _MeshNormal_ST.zw;
				...
				float3 triplanar585 = TriplanarSampling585( _BaseLayerNormal, _BaseLayerNormal_ST, sampler_BaseLayerNormal, PositionWS, NormalWS, 1.0, temp_cast_4, _Normal1Scale, 0 );
				...
				float4 triplanar590 = TriplanarSampling590( _TopLayerMask, _TopLayerMask_ST, sampler_TopLayerMask, PositionWS, NormalWS, 1.0, temp_cast_5, 1.0, 0 );
				...
				float3 triplanar592 = TriplanarSampling592( _TopLayerNormal, _TopLayerNormal_ST, sampler_TopLayerNormal, PositionWS, NormalWS, 1.0, temp_cast_7, _TopNormalScale, 0 );
				...
				float4 triplanar584 = TriplanarSampling584( _BaseLayerMask, _BaseLayerMask_ST, sampler_BaseLayerMask, PositionWS, NormalWS, 1.0, float2( 1,1 ), 1.0, 0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 triplanar582 = TriplanarSampling582( _BaseLayerBaseColor, _BaseLayerBaseColor_ST, sampler_BaseLayerBaseColor, PositionWS, ase_normalWS, 1.0, temp_cast_0, 1.0, 0 );
				float4 BC133 = ( _Color1 * triplanar582 );
				...
				float4 ColorBlend177 = ( saturate( lerpBlendMode86 ));
				float2 temp_cast_2 = (_TopLayerTiling).xx;
				float4 triplanar588 = TriplanarSampling588( _TopLayerBaseColor, _TopLayerBaseColor_ST, sampler_TopLayerBaseColor, PositionWS, ase_normalWS, 1.0, temp_cast_2, 1.0, 0 );
				float4 TopBC187 = ( _TopLayerColor * triplanar588 );
				...
				float3 triplanar585 = TriplanarSampling585( _BaseLayerNormal, _BaseLayerNormal_ST, sampler_BaseLayerNormal, PositionWS, ase_normalWS, 1.0, temp_cast_4, _Normal1Scale, 0 );
				float3 tanTriplanarNormal585 = mul( ase_worldToTangent, triplanar585 );
				float3 NM136 = tanTriplanarNormal585;
				float3 NormalBlend112 = BlendNormal( MeshNormal7 , NM136 );
				...
				float temp_output_230_0 = ( worldNormal110.y - _TopMaskAmount );
				float2 temp_cast_5 = (_TopLayerTiling).xx;
				float4 triplanar590 = TriplanarSampling590( _TopLayerMask, _TopLayerMask_ST, sampler_TopLayerMask, PositionWS, ase_normalWS, 1.0, temp_cast_5, 1.0, 0 );
				float TopHeight232 = triplanar590.z;
				float saferPower238 = abs( TopHeight232 );
				float lerpResult243 = lerp( 0.0 , ( pow( saferPower238 , _TopHeightBlendAmount ) * _TopHeightMapStrength ) , temp_output_230_0);
				float saferPower136 = abs( saturate( ( ( pow( temp_output_230_0 , 5.0 ) * _TopHeightUpStrength ) + lerpResult243 ) ) );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 temp_cast_0 = (_Texture1Tiling).xx;
				float3x3 ase_worldToTangent = float3x3( TangentWS, BitangentWS, NormalWS );
				float3 triplanar585 = TriplanarSampling585( _BaseLayerNormal, _BaseLayerNormal_ST, sampler_BaseLayerNormal, PositionWS, NormalWS, 1.0, temp_cast_0, _Normal1Scale, 0 );
				float3 tanTriplanarNormal585 = mul( ase_worldToTangent, triplanar585 );
				float3 NM136 = tanTriplanarNormal585;
				float3 NormalBlend112 = BlendNormal( MeshNormal7 , NM136 );
				float2 temp_cast_1 = (_TopLayerTiling).xx;
				float3 triplanar592 = TriplanarSampling592( _TopLayerNormal, _TopLayerNormal_ST, sampler_TopLayerNormal, PositionWS, NormalWS, 1.0, temp_cast_1, _TopNormalScale, 0 );
				float3 tanTriplanarNormal592 = mul( ase_worldToTangent, triplanar592 );
				float3 TopNM194 = tanTriplanarNormal592;
				float3 tanToWorld0 = float3( TangentWS.x, BitangentWS.x, NormalWS.x );
				float3 tanToWorld1 = float3( TangentWS.y, BitangentWS.y, NormalWS.y );
				...
				float temp_output_230_0 = ( worldNormal110.y - _TopMaskAmount );
				float2 temp_cast_2 = (_TopLayerTiling).xx;
				float4 triplanar590 = TriplanarSampling590( _TopLayerMask, _TopLayerMask_ST, sampler_TopLayerMask, PositionWS, NormalWS, 1.0, temp_cast_2, 1.0, 0 );
				float TopHeight232 = triplanar590.z;
				float saferPower238 = abs( TopHeight232 );
				float lerpResult243 = lerp( 0.0 , ( pow( saferPower238 , _TopHeightBlendAmount ) * _TopHeightMapStrength ) , temp_output_230_0);
				float saferPower136 = abs( saturate( ( ( pow( temp_output_230_0 , 5.0 ) * _TopHeightUpStrength ) + lerpResult243 ) ) );
...
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;6;-3381.368,-781.2898;Inherit;True;Property;_MeshNormal;Mesh Normal;1;2;[Normal];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;cf24ac4cda719174094ac7d1041d1824;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;252;1586.614,-291.8054;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;10;TriForge/Mask Blend;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;51;Category;0;0;  Instanced Terrain Normals;1;0;Lighting Model;0;0;Workflow;1;0;Surface;0;0;  Keep Alpha;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Alpha Clipping;1;0;  Use Shadow Threshold;0;0;Fragment Normal Space;0;638340102524490687;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,True,_TranslucencyStrength;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;Receive Shadows;1;0;Specular Highlights;1;0;Environment Reflections;1;0;Receive SSAO;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;  XR Motion Vectors;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position;1;0;Debug Display;0;0;Clear Coat;0;0;0;12;False;True;True;True;True;True;True;True;True;True;True;False;False;;True;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;253;1586.614,-291.8054;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;254;1586.614,-291.8054;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;255;1586.614,-291.8054;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;259;1586.614,-291.8054;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;260;1586.614,-291.8054;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;593;1586.614,-191.8054;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;594;1586.614,-191.8054;Float;False;False;-1;3;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;XRMotionVectors;0;11;XRMotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;14;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;True;1;False;;255;False;;1;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;False;True;1;LightMode=XRMotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=7A98AECC7B2DC62469EF3E589AEBD7837584095A