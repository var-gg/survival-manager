...
public enum BattleLogCode { Generic = 0, BasicAttackDamage = 1, ActiveSkillDamage = 2, ActiveSkillHeal = 3, WaitDefend = 4, ComboPayoffDamage = 5, SecondaryPressureDamage = 6 }
