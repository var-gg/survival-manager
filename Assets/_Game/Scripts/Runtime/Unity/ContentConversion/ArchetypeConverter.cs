    ...
    internal static FootprintProfile BuildFootprintProfile(UnitArchetypeDefinition definition)
    {
        ...
        return definition.Class != null ? definition.Class.Id switch
        {
            "vanguard" => new FootprintProfile(
                Mathf.Max(0.42f, collisionRadius - 0.04f),
                Mathf.Max(0.7f, collisionRadius + 0.2f),
                Mathf.Min(0.68f, attackRange),
            ...
            "duelist" => new FootprintProfile(
                Mathf.Max(0.38f, collisionRadius - 0.1f),
                Mathf.Max(0.62f, collisionRadius + 0.12f),
                Mathf.Min(0.58f, attackRange),
            ...
            "ranger" => new FootprintProfile(
                ...
                attackRange,
                new FloatRange(Mathf.Max(5f, attackRange - 0.6f), Mathf.Max(5.8f, attackRange + 0.2f)),
                3,
            ...
            _ => new FootprintProfile(
                Mathf.Max(0.4f, collisionRadius - 0.05f),
                Mathf.Max(0.65f, collisionRadius + 0.15f),
                Mathf.Min(0.65f, attackRange),
                new FloatRange(Mathf.Min(0.65f, Mathf.Max(0.55f, attackRange - 0.65f)), attackRange),
                4,
                0.95f,
                BodySizeCategory.Medium,
                2f),
