...
public static partial class LocalizationFoundationBootstrap
{
    ...
    private static readonly Dictionary<string, (string ko, string en, bool smart)> SharedEntries = new(StringComparer.Ordinal)
    {
        ...
        ["ui.reward.title"] = ("보상 정산", "Battle Rewards", false),
        ...
        ["system.bootstrap.missing_sample_content.player"] = ("필수 샘플 콘텐츠 canonical root가 비어 있어 시작할 수 없습니다. normal playable path는 Resources content contract만 허용합니다.", "Required sample content canonical root is empty, so boot cannot continue. The normal playable path only accepts the Resources content contract.", false),
    ...
    private static void EnsureClosureEntries()
    {
        ...
        AddOrUpdateEntries(new Dictionary<string, (string ko, string en, bool smart)>(StringComparer.Ordinal)
        {
            ...
            ["ui.town.refit.reason.town_only"] = ("재련 작업은 Town에서만 할 수 있습니다.", "Crafting is available only in Town.", false),
            ...
            ["ui.town.tooltip.quick_battle"] = ("authored 캠페인 진행을 건드리지 않고 짧은 전투만 엽니다.", "Open a short combat check without altering authored campaign progress.", false),
            ["ui.town.tooltip.quick_battle_smoke"] = ("현재 Town 빌드 상태로 짧은 전투를 열고, Reward 또는 직접 Town 복귀 의미를 유지합니다.", "Open a short battle using the current Town build, then return through Reward or direct Town restore.", false),
        ...
        AddOrUpdateEntries(new Dictionary<string, (string ko, string en, bool smart)>(StringComparer.Ordinal)
        {
            ...
            ["ui.town.campaign.quick_battle_locked"] = ("현재 expedition run이 닫히기 전까지 빠른 전투는 잠깁니다.", "Quick Battle is locked until the current expedition run is closed.", false),
        ...
        AddOrUpdateEntries(new Dictionary<string, (string ko, string en, bool smart)>(StringComparer.Ordinal)
        {
            ...
            ["ui.town.error.quick_battle_locked"] = ("authored 원정 런이 열려 있는 동안 빠른 전투는 사용할 수 없습니다.", "Quick Battle is locked while an authored expedition run is active.", false),
        ...
        AddOrUpdateEntries(new Dictionary<string, (string ko, string en, bool smart)>(StringComparer.Ordinal)
        {
            ...
            ["ui.battle.action.return_town_debug"] = ("Town 복귀", "Return to Town", false),
            ...
            ["ui.battle.error.return_town_smoke_only"] = ("직접 Town 복귀는 빠른 전투에서만 사용할 수 있습니다.", "Direct return to Town is only available in Quick Battle.", false),
            ...
            ["ui.battle.tooltip.replay"] = ("현재 빠른 전투 timeline을 처음부터 다시 재생합니다.", "Replay the current Quick Battle timeline from the start.", false),
            ...
            ["ui.battle.tooltip.rebattle"] = ("새 seed로 빠른 전투를 다시 시작합니다.", "Restart Quick Battle with a fresh seed.", false),
            ...
            ["ui.battle.tooltip.return_town_direct"] = ("전투가 끝난 뒤 빠른 전투를 정리하고 즉시 Town으로 돌아갑니다.", "Leave Quick Battle after the battle is resolved and go directly back to Town.", false),
            ...
            ["ui.battle.tooltip.dominant_hand"] = ("유닛의 주손 방향. 자세/모션 좌우 mirroring 기준.", "Unit's dominant hand. Determines the basis for posture and motion mirroring.", false),
        ...
        AddOrUpdateEntries(new Dictionary<string, (string ko, string en, bool smart)>(StringComparer.Ordinal)
        {
            ...
            ["ui.reward.action.return_town_smoke"] = ("Town 복귀 / 빠른 전투 완료", "Return to Town / Quick Battle Complete", false),
            ...
            ["ui.reward.status.default.quick"] = ("빠른 전투 정산입니다. 카드 한 장을 고르고 Town으로 돌아가세요.", "Quick Battle settlement: pick one card and return to Town.", false),
