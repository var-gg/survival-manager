...
internal static class EquipmentContentV1Contract
{
    ...
    internal static readonly IReadOnlyList<EquipmentAffixV1Spec> AffixSpecs = new[]
    {
        ...
        Live("affix_relentless", AffixTierValue.Suffix, AffixFamilyValue.BuildShaping, AffixEffectTypeValue.RuleModifier, AffixCategoryValue.SynergyTagged, "attack_speed", ModifierOp.Increased, 0.04f, 0.08f, Slots(ItemSlotType.Weapon, ItemSlotType.Accessory), Tags("tempo", "execute"), Tags(), Tags("tempo", "execute"), "build.relentless_tempo", "content.affix.template.build", 12f),
        Live("affix_watchful", AffixTierValue.Suffix, AffixFamilyValue.BuildShaping, AffixEffectTypeValue.RuleModifier, AffixCategoryValue.SynergyTagged, "crit_chance", ModifierOp.Increased, 0.03f, 0.06f, Slots(ItemSlotType.Weapon, ItemSlotType.Accessory), Tags("mark", "backline"), Tags(), Tags("mark", "backline"), "build.watchful_mark", "content.affix.template.build", 12f),
        Live("affix_packborn", AffixTierValue.Suffix, AffixFamilyValue.BuildShaping, AffixEffectTypeValue.RuleModifier, AffixCategoryValue.SynergyTagged, "max_health", ModifierOp.Flat, 2f, 4f, Slots(ItemSlotType.Armor, ItemSlotType.Accessory), Tags("support", "sustain"), Tags(), Tags("support", "sustain"), "build.packborn_sustain", "content.affix.template.build", 12f),
        Live("affix_wraithbound", AffixTierValue.Suffix, AffixFamilyValue.BuildShaping, AffixEffectTypeValue.RuleModifier, AffixCategoryValue.SynergyTagged, "mag_power", ModifierOp.Flat, 1f, 3f, Slots(ItemSlotType.Weapon, ItemSlotType.Accessory), Tags("magical", "wildcard_risk"), Tags(), Tags("magical", "wildcard_risk"), "build.wraithbound_magic", "content.affix.template.build", 12f),
