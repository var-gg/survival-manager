...
public static partial class BattleMapCatalogBootstrap
{
    ...
    private static void EnsureWolfPineRoadEdgeBreakup(Transform root)
    {
        ...
        AddVendorPrefab(edgeRoot, "EdgeFern_CenterTop_02", "Assets/TriForge Assets/Fantasy Worlds - Forest/Prefabs/Foliage/Summer/P_fwOF_Fern_02.prefab", new Vector3(2.6f, -1.055f, 2.78f), new Vector3(0f, 34f, 0f), new Vector3(0.86f, 0.86f, 0.86f));
        ...
        AddVendorPrefab(edgeRoot, "EdgeGrass_CenterBottom_01", "Assets/TriForge Assets/Fantasy Worlds - Forest/Prefabs/Foliage/Summer/P_fwOF_Grass_S_01.prefab", new Vector3(-1.4f, -1.055f, -2.78f), new Vector3(0f, 66f, 0f), new Vector3(1.00f, 1.00f, 1.00f));
        ...
        AddVendorPrefab(edgeRoot, "EdgeFern_EnemyBottom_01", "Assets/TriForge Assets/Fantasy Worlds - Forest/Prefabs/Foliage/Summer/P_fwOF_Fern_01.prefab", new Vector3(5.4f, -1.055f, -2.72f), new Vector3(0f, -34f, 0f), new Vector3(0.84f, 0.84f, 0.84f));
