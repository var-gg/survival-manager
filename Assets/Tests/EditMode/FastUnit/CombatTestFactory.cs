...
public static class CombatTestFactory
{
        ...
        EnergyProfile? energy = null)
    {
        ...
        return new BattleUnitLoadout(
            ...
            BasicAttack: basicAttack ?? new BattleBasicAttackSpec($"{id}:basic", "Basic", DamageType.Physical, basicAttackTargetRule ?? new TargetRule()),
