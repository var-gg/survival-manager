...
{
    // Fake lookup 기반으로 GUI 모드에서도 에디터 freeze 없이 빠르게 실행된다.
    private static readonly FakeCombatContentLookup SharedLookup = EditorFreeCombatContentFixture.CreateTownBuildLookup();
