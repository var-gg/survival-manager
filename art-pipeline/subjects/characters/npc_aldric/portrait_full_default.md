---
slug: npc_aldric--portrait_full_default
...
status: rendered
---
# 단현 스턴홀트 (丹玄) / Aldric Sternfeld — Portrait Full Default
...
```prompt
Create one full-body polished JRPG character illustration of 단현 스턴홀트 (丹玄) / Aldric Sternfeld, using the attached references with strict priority:

REFERENCE PRIORITY
1. The attached P09 model reference for npc_aldric is CANON for identity, outfit slots, silhouette, hair, weapon, shield state, and color zoning.
...
- Hair: #D8D4C8
- Chest / top color zone: #5C5A58
- Waist / lower color zone: #2A2A2E
- Leg / lower color zone: #3F3B36
