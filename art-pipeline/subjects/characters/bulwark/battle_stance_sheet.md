---
slug: bulwark--battle_stance_sheet
...
- cast
---
# 송곳벽 / Fang Bulwark — Battle Stance Sheet

## prompt 명세

```prompt
Create a 2-column x 2-row full-body battle stance sprite sheet for 송곳벽 / Fang Bulwark.
...
- ShieldId 2: render the shield exactly as P09 shows in every stance where the shield arm is visible.
