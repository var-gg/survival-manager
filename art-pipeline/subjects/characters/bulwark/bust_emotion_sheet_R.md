---
slug: bulwark--bust_emotion_sheet_R
...
- quiet
---
# 송곳벽 / Fang Bulwark — Bust Emotion Sheet R

## prompt 명세

```prompt
Create a 4-column x 2-row bust emotion sprite sheet for 송곳벽 / Fang Bulwark, facing camera-right.
