---
slug: hero_ember_runner--portrait_full_default
...
status: rendered
---
# 연주 (燕走) / Ember Runner — Portrait Full Default
...
```prompt
Create one full-body polished JRPG character illustration of 연주 (燕走) / Ember Runner, using the attached references with strict priority:

REFERENCE PRIORITY
1. The attached P09 model reference for hero_ember_runner is CANON for identity, outfit slots, silhouette, hair, weapon, shield state, and color zoning.
...
- Hair: #B66A34
- Chest / top color zone: #8A6B3E
- Waist / lower color zone: #5A3A25
- Leg / lower color zone: #7A4A32
- Weapon: #8A6A3F
