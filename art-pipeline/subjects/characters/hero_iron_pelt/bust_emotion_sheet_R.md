---
slug: hero_iron_pelt--bust_emotion_sheet_R
...
- quiet
---
# 철피 (鐵皮) / Iron Pelt — Bust Emotion Sheet R

## prompt 명세

```prompt
Create a 4-column x 2-row bust emotion sprite sheet for 철피 (鐵皮) / Iron Pelt, facing camera-right.
