---
slug: bastion_penitent--battle_stance_sheet
...
- cast
---
# 참회벽 / Bastion Penitent — Battle Stance Sheet

## prompt 명세

```prompt
Create a 2-column x 2-row full-body battle stance sprite sheet for 참회벽 / Bastion Penitent.
