---
slug: hero_prism_seeker--face_combat_state_sheet
...
- downed
---
# 광로 (光路) / Prism Seeker — Face Combat State Sheet

## prompt 명세

```prompt
Create a 3-column x 2-row face combat-state sprite sheet for 광로 (光路) / Prism Seeker.
