---
slug: reaver--portrait_full_default
...
status: rendered
---
# 묵괴 (墨壞) / Grave Reaver — Portrait Full Default
...
```prompt
Create one full-body polished JRPG character illustration of 묵괴 (墨壞) / Grave Reaver, using the attached references with strict priority:

REFERENCE PRIORITY
1. The attached P09 model reference for reaver is CANON for identity, outfit slots, silhouette, hair, weapon, shield state, and color zoning.
...
- Hair: #CFCAC0
- Chest / top color zone: #4A4648
- Waist / lower color zone: #3E3A36
- Leg / lower color zone: #5C5A58
- Weapon: #3B3745
