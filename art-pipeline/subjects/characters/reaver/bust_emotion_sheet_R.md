---
slug: reaver--bust_emotion_sheet_R
...
- quiet
---
# 묵괴 (墨壞) / Grave Reaver — Bust Emotion Sheet R

## prompt 명세

```prompt
Create a 4-column x 2-row bust emotion sprite sheet for 묵괴 (墨壞) / Grave Reaver, facing camera-right.
