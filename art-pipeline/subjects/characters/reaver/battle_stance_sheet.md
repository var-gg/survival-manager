---
slug: reaver--battle_stance_sheet
...
- cast
---
# 묵괴 (墨壞) / Grave Reaver — Battle Stance Sheet

## prompt 명세

```prompt
Create a 2-column x 2-row full-body battle stance sprite sheet for 묵괴 (墨壞) / Grave Reaver.
