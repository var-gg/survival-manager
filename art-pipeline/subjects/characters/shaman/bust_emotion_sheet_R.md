---
slug: shaman--bust_emotion_sheet_R
...
- quiet
---
# 풍의 (風儀) / Storm Shaman — Bust Emotion Sheet R

## prompt 명세

```prompt
Create a 4-column x 2-row bust emotion sprite sheet for 풍의 (風儀) / Storm Shaman, facing camera-right.
