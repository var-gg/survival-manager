---
slug: npc_baekgyu_sternheim--face_emotion_sheet
...
- quiet
---
# 백규 (白圭) / Baekgyu Sternheim — Face Emotion Sheet

## prompt 명세

```prompt
Create a 4-column x 2-row face emotion sprite sheet for 백규 (白圭) / Baekgyu Sternheim.
