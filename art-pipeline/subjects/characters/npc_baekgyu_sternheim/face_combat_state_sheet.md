---
slug: npc_baekgyu_sternheim--face_combat_state_sheet
...
- downed
---
# 백규 (白圭) / Baekgyu Sternheim — Face Combat State Sheet

## prompt 명세

```prompt
Create a 3-column x 2-row face combat-state sprite sheet for 백규 (白圭) / Baekgyu Sternheim.
