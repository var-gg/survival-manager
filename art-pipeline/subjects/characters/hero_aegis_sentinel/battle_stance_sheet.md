---
slug: hero_aegis_sentinel--battle_stance_sheet
...
- cast
---
# 방진 (方陣) / Aegis Sentinel — Battle Stance Sheet

## prompt 명세

```prompt
Create a 2-column x 2-row full-body battle stance sprite sheet for 방진 (方陣) / Aegis Sentinel.
