---
slug: hero_aegis_sentinel--portrait_full_default
...
status: rendered
---
# 방진 (方陣) / Aegis Sentinel — Portrait Full Default
...
```prompt
Create one full-body polished JRPG character illustration of 방진 (方陣) / Aegis Sentinel, using the attached references with strict priority:

REFERENCE PRIORITY
1. The attached P09 model reference for hero_aegis_sentinel is CANON for identity, outfit slots, silhouette, hair, weapon, shield state, and color zoning.
...
- Hair: #C9C6BC
- Chest / top color zone: #9EA5B0
- Waist / lower color zone: #4B3A32
- Leg / lower color zone: #7E8792
- Weapon: #B8B0C8
- Shield: #D8D2E3
