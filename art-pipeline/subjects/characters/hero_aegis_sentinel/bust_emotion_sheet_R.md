---
slug: hero_aegis_sentinel--bust_emotion_sheet_R
...
- quiet
---
# 방진 (方陣) / Aegis Sentinel — Bust Emotion Sheet R

## prompt 명세

```prompt
Create a 4-column x 2-row bust emotion sprite sheet for 방진 (方陣) / Aegis Sentinel, facing camera-right.
