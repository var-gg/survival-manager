---
slug: mirror_cantor--bust_emotion_sheet_R
...
- quiet
---
# 명음 (明音) / Mirror Cantor — Bust Emotion Sheet R

## prompt 명세

```prompt
Create a 4-column x 2-row bust emotion sprite sheet for 명음 (明音) / Mirror Cantor, facing camera-right.
