---
slug: mirror_cantor--face_emotion_sheet
...
- quiet
---
# 명음 (明音) / Mirror Cantor — Face Emotion Sheet

## prompt 명세

```prompt
Create a 4-column x 2-row face emotion sprite sheet for 명음 (明音) / Mirror Cantor.
