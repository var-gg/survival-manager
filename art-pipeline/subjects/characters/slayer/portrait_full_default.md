---
slug: slayer--portrait_full_default
...
status: rendered
---
# 서검 (誓劍) / Oath Slayer — Portrait Full Default
...
```prompt
Create one full-body polished JRPG character illustration of 서검 (誓劍) / Oath Slayer, using the attached references with strict priority:

REFERENCE PRIORITY
1. The attached P09 model reference for slayer is CANON for identity, outfit slots, silhouette, hair, weapon, shield state, and color zoning.
