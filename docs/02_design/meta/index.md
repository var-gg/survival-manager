...
Town/expedition loop, 경제, 모집, 장비, augment, synergy, PVP, 캠페인 진행 등 메타 시스템 설계 문서를 모은다.
...
- narrative beat와 감정값은 `docs/02_design/narrative/chapter-beat-sheet.md`가 소유한다.
