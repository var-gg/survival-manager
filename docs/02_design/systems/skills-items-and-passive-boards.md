...
- support modifier는 stable tag compatibility를 통과한 경우에만 `support` slot에 들어간다.
- 무기 패밀리 제한과 class 제한은 compile 이전 validation에서 걸러진다.

## launch floor 범위

- equipment slot: `weapon / armor / accessory`
- skill slot: `core_active / utility_active / passive / support`
...
- keyword/support/weapon restriction은 `docs/02_design/combat/skill-keywords-support-modifiers-and-weapon-restrictions.md`가 소유한다.
