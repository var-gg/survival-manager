...
전환점은 심문관 격파 후 발견되는 요새 심부의 격자 연구 기록이다. 왕국이 격자 파편을 체계적으로 수거하여 군사 방벽에 이식했고, 이것이 Heartforge 봉인의 풍화를 가속했다는 인과가 명확해진다. Dawn Priest의 신앙이 처음으로 균열을 보이는 순간이며, `hero_bastion_penitent`는 이 진실을 목격하고 참회를 선택한 왕국 내부자로, `hero_pale_executor`는 진실을 알면서도 질서를 택하다 환멸한 집행자로 합류한다. Pack Raider는 이 폭로에 분노하지만, 동시에 Dawn Priest가 자기 세력의 죄를 직시하려는 태도에 처음으로 존중의 기미를 보인다.
...
Bone Orchard에서 캠페인 전체의 최대 반전이 일어난다. 유골이 뿌리처럼 자라난 석화 과수원의 중심부에서, 봉인 격자 조각이 빛나기 시작하고 Relicborn이 각성한다. 모든 세력이 이 존재를 침략자로 예상했지만, 고대 기억 투사가 펼쳐지면서 진실이 드러난다. Heartforge가 가동되기 전, 네 종족이 적대감 없이 공존했던 시대의 기억이다. Relicborn은 그 공존을 지키기 위해 Heartforge를 봉인하고 자발적 휴면에 들어갔던 수문장이었다. 지금 각성한 것은 격자가 임계치 이하로 풍화되었기 때문이며, 그들은 공격이 아니라 긴급 복구를 시도하고 있었다.
...
이 챕터에서 네 시점 캐릭터의 서사가 교차한다. Dawn Priest는 유리 속에 박힌 왕국의 방벽 장치가 실은 도난당한 격자 파편임을 현장에서 확인한다. 그의 신앙 위기는 여기서 최저점에 도달한다. Pack Raider는 유리화된 동물 우리(Starved Menagerie)에서 과거 야수족이 기르던 생물들의 잔해를 발견하고, 야수족의 본능적 분노가 Heartforge 공명의 결과였음을 체감한다. Relicborn의 격자가 야수족의 본능을 완화할 수 있다는 사실이 여기서 증명되며, 이것은 적이라 믿었던 존재가 치료제였다는 역설이다. Grave Hexer는 유리 속에 갇힌 기억들이 자신의 Memory Conclave 기록과 일치하는 것을 발견하고, 모든 세력의 고통이 같은 원인에서 비롯되었음을 기억의 증거로 입증한다.

전환점은 네 세력이 같은 상처를 다른 언어로 말하고 있었다는 인식이 도달하는 장면이다. Dawn Priest는 그것을 오염이라 불렀고, Pack Raider는 영역 침범이라 불렀고, Grave Hexer는 기억 소실이라 불렀고, Echo Savant는 격자 풍화라 불렀다. 이름이 달랐을 뿐, 가리키는 상처는 하나였다. 이 깨달음은 4세력 공감의 기반을 형성하지만, 완전한 화해가 아니라 불완전한 연대다. 80년 전 격자를 훔친 왕국에 대한 분노는 여전히 남아 있고, 야수족의 본능적 불신은 하룻밤에 사라지지 않는다. 그러나 Heartforge를 멈추지 않으면 모두가 멸망한다는 점에서, 생존을 위한 수렴이 시작된다. `hero_shardblade`와 `hero_prism_seeker`가 합류하면서 Relicborn의 전열돌파/추적 축이 완성되고, 원정대는 처음으로 네 세력 완전 편성으로 운용된다.

**마감 시퀀스**: 유리 숲의 개활지에서 원정대가 Worldscar를 향해 하강로를 바라본다. 결정 나무 사이로 석양빛이 굴절되어 네 색깔의 빛이 원정대 위로 떨어진다. 강철 회색, 호박색, 인광 녹색, 프리즘 보라. 네 세력의 색채가 처음으로 한 공간에 겹친다. 아무도 말하지 않는다. Pack Raider가 먼저 걷기 시작하고, 나머지가 따른다. 유리가 부서지는 소리만이 그들의 행군을 알린다.

---

### Chapter 5: Heartforge Descent — 심장로 하강

**감정 아크**: 결의 → 극한의 시험 → 순환의 종결

Worldscar 입구의 거대한 석조 관문에는 네 세력의 문양이 각각 새겨져 있다. 격자의 잔재가 문을 봉인하고 있으며, Heartforge의 맥동이 가슴팍까지 울린다. 이 챕터에서는 새로운 시스템이 도입되지 않는다. 원정대가 지금까지 배운 모든 것을 사용해 하강하는, 결산과 payoff의 공간이다. 네 시점 캐릭터 각각이 자신의 세력이 지닌 격자 파편과 기억과 지식을 하나로 모으는 과정이 서사의 중심이며, 각자의 내면 아크가 절정에 도달한다.

Dawn Priest의 신앙 위기는 여기서 해결된다. Heartforge 관문 앞에서 그는 더 이상 영원한 질서의 기도를 올리지 않는다. 대신, 격자 복원에 필요한 정화 의식을 Relicborn의 방식으로 수행한다. 이것은 신앙의 포기가 아니라 신앙의 재정의다. 질서는 위에서 부과하는 것이 아니라 격자처럼 서로가 서로를 지탱하는 것이라는 이해에 도달한다. Pack Raider의 외부인-동맹 아크는 관문 진입 맹세에서 완성된다. 씨족의 전통에 따라 그가 원정대 앞에서 이빨을 보이며 서약하는 장면은, 야수족에게 이빨을 보이는 것이 신뢰의 최고 표현이라는 맥락을 아는 플레이어에게 감정적 정점이 된다. Grave Hexer의 기억 빚 아크는 심부에서 절정을 맞는다. Heartforge 벽면에 투사된 모든 종족의 기억 속에서, 그녀는 자신의 가장 오래된 기억이 봉인 실패의 순간 것임을 확인한다. 그녀의 존재 이유와 빚은 여기서 비로소 하나의 답을 얻는다.

Worldscar 심부에서 최종 적대체와의 전투가 벌어진다. 이 존재는 Heartforge가 자기 방어를 위해 축적한 적대감의 결정체이며, 특정 악당이 아니라 순환 그 자체의 구현이다. 전투는 네 세력의 능력을 모두 요구하도록 설계되며, 어느 한 세력만으로는 돌파가 불가능하다. 격파 후, Echo Savant가 격자 복원을 주도하고 나머지 세 인물이 각자의 세력이 보유한 격자 파편을 제자리에 돌려놓는다. Heartforge는 파괴되지 않는다. 파괴하면 모든 기억이 소실되기 때문이다. 대신 정화와 봉인을 통해 출력이 억제되고, 적대감 증폭 순환이 정지된다.

엔딩은 승리의 환호가 아니라 긴 전쟁이 끝난 뒤의 고요다. 네 세력이 각자의 방식으로 세계를 수습하는 모습이 교차 편집된다. 왕국은 격자를 돌려주고 Steward Council이 재편을 시작한다. 야수족은 사냥터로 돌아가되, 본능의 증폭이 사라진 세계에서 처음으로 평온한 사냥을 한다. 언데드는 기억이 더 이상 왜곡되지 않는 묘역으로 돌아간다. Relicborn은 격자 수복을 계속하지만, 내부에서 노선 분열의 조짐이 보인다. 정치 재편, Relicborn 분열, 외부 대륙 신호가 후속작 hook으로 남지만, main conflict는 완결된다.

**마감 시퀀스**: Heartforge가 정지한 뒤, 심부의 벽면에서 기억 투사가 마지막으로 한 번 빛난다. 네 종족이 공존했던 태초기의 기억이 아니라, 방금 이 자리에서 네 세력이 함께 싸운 기억이다. 새로운 기억이 가장 오래된 기억 위에 겹쳐진다. Dawn Priest가 위를 올려다본다. Worldscar의 좁은 틈 사이로 하늘이 보인다. 재가 아니라 빛이 내려온다. 원정대가 상승을 시작한다. 길고 느린 상승이다. 카메라가 마지막으로 Heartforge를 비추면, 심장은 뛰지 않는다. 고요하다. 그리고 아주 먼 곳에서, 격자가 감지하지 못하는 방향에서, 희미한 신호 하나가 깜빡인다.
