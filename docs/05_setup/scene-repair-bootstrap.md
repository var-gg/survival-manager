...
1. Unity 열기
2. 먼저 canonical newcomer lane이면 `SM/Setup/Prepare Observer Playable`
3. 복구만 필요하면 `SM/Setup/Repair First Playable Scenes`
4. locale foundation이 의심되면 `SM/Setup/Ensure Localization Foundation`
