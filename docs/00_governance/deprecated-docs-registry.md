...
| `docs/05_setup/postgres-setup.md` | `docs/03_architecture/persistence-strategy.md`; `docs/04_decisions/adr-0009-persistence-boundary.md` | `docs/04_decisions/adr-0017-docs-context-harness.md` | 2026-04-07 | 2026-04-14 | removed | runtime persistence contract를 JSON-only로 고정하면서 experimental local Postgres setup 문서를 active tree에서 제거했다. |
| `docs/04_decisions/adr-0010-local-postgres-policy.md` | `docs/03_architecture/persistence-strategy.md`; `docs/04_decisions/adr-0009-persistence-boundary.md` | `docs/04_decisions/adr-0017-docs-context-harness.md` | 2026-04-07 | 2026-04-14 | removed | local Postgres 정책을 더 이상 active runtime decision으로 유지하지 않고 JSON-only persistence contract로 정리했다. |
| `docs/02_design/combat/skill-catalog-v1.md` | `docs/02_design/systems/launch-floor-content-matrix.md`; `docs/02_design/combat/skill-authoring-schema.md`; `docs/02_design/combat/skill-taxonomy-and-damage-model.md` | `docs/04_decisions/adr-0017-docs-context-harness.md` | 2026-05-06 | 2026-05-09 | removed | 7-packet seed 초안이 12 archetype launch floor matrix와 namespace가 달라 active SoT에서 제거했다. |
| `docs/02_design/combat/synergy-system.md` | `docs/02_design/meta/synergy-and-augment-taxonomy.md`; `docs/02_design/meta/synergy-breakpoints-and-soft-counters.md`; `docs/02_design/meta/synergy-family-catalog.md`; `docs/02_design/systems/launch-floor-content-matrix.md` | `docs/04_decisions/adr-0017-docs-context-harness.md` | 2026-05-06 | 2026-05-09 | removed | class synergy 2/4 초안과 old race naming이 launch floor 2/3·narrative reskin 기준과 충돌해 대체 SoT로 분리했다. |
