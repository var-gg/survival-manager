...
pure asmdef, `SM.Tests.FastUnit`의 `SM.Editor`/editor-only package 참조 금지, FastUnit category 전용 폴더 고정, Meta forbidden token, FastUnit authored-object 금지, public session constructor 금지,
