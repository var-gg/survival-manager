...
- recovery lane:
  ...
  - `SM/Setup/Ensure Localization Foundation`
...
- clean clone newcomer witness: Unity `6000.4.0f1`만으로 `Prepare Observer Playable -> Boot -> Start Local Run`
...
- recovery: `Prepare Observer Playable`, `Repair First Playable Scenes`, `Ensure Localization Foundation`
