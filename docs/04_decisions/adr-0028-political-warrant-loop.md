...
- **combat-time provenance**: combat event schema에 `SourceFactionId/Channel/ReasonCode` slot을 박아 전투 중 정치 marker를 남긴다. 안 박으면 #1 마지막 20% 닫을 때 modifier application/event log/replay를 다시 관통.
